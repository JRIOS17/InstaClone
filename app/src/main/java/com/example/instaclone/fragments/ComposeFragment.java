...
public class ComposeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        descripton = view.findViewById(R.id.etDescription);
        imgCapture = view.findViewById(R.id.picButton);
        img = view.findViewById(R.id.pic);
        submitBtn = view.findViewById(R.id.postButton);
        ...
        submitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(photoFile == null || img.getDrawable() == null){
